...
export function mockGetDishDetail(dishId: string): DishDetail | null {
  ...
  return {
    ...
    createdByDisplayName: 'Palato.me',
  };
}
  ...
  return [
    {
      ...
      reviewCount: 48,
      priceTier: '$$',
      restaurantId: 'kengai-sushi',
      restaurantSlug: 'kengai-sushi',
      restaurantName: 'Kengai Sushi',
    ...
    },
    {
      ...
      reviewCount: 22,
      priceTier: '$',
      restaurantId: 'chichilo',
      restaurantSlug: 'chichilo',
      restaurantName: 'CHICHILO',
