...
export default function AddDishModal({
  ...
  const t = useTranslations('restaurant.addDishModal');
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-end">
              ...
              >
                <FontAwesomeIcon
                  ...
                  aria-hidden
                />
                {submitMode === 'just-add' ? t('adding') : t('justAdd')}
              </button>
              ...
              {onDishCreatedAndReview && (
                ...
                >
                  <FontAwesomeIcon
                    ...
                    aria-hidden
                  />
                  {submitMode === 'and-review' ? t('adding') : t('addAndReview')}
                </button>
              )}
            </div>
          </footer>
    ...
    >
      <div className="flex items-center gap-2 border-b border-border-subtle px-3.5 py-2">
        ...
        <p className="m-0 font-sans text-[11px] font-semibold uppercase tracking-[0.14em] text-text-secondary">
          {exact ? t('duplicatesExact') : t('duplicatesMaybe')}
        </p>
      </div>
              ...
              <div className="min-w-0 flex-1">
                ...
                {d.review_count > 0 && (
                  <p className="m-0 font-sans text-[11px] text-text-muted">
                    {d.review_count === 1
                      ? t('reviewOne', { count: d.review_count })
                      : t('reviewMany', { count: d.review_count })}
                  </p>
                )}
              </div>
