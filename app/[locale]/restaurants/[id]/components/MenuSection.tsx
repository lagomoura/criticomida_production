...
export default function MenuSection({
  ...
  const t = useTranslations('restaurant.menuSection');
      ...
      <div className="cc-card shadow-sm">
        <div className="cc-card-body">
          <div className="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h4 className="card-title mb-0 text-lg">{t('title')}</h4>
            <button
              className={
          ...
          {menu ? (
            <div className="flex flex-col items-start gap-3 sm:flex-row">
              ...
              <div className="flex flex-col justify-center">
                <div className="mb-2 flex items-center gap-2 text-muted">
                  ...
                  <small>
                    {t('uploadedOn', {
                      date: new Date(menu.uploadDate).toLocaleDateString(locale, {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric',
                      }),
            ...
            <div className="py-4 text-center">
              ...
              <h5 className="text-muted">{t('noMenu')}</h5>
