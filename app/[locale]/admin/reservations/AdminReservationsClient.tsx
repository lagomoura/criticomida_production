...
export default function AdminReservationsClient() {
  ...
  const PROVIDER_OPTIONS = useMemo(() => [
    ...
    { value: 'whatsapp', label: t('providerWhatsapp') },
    { value: 'own_site', label: t('providerOwnSite') },
    { value: 'opentable', label: t('providerOpentable') },
    { value: 'thefork', label: t('providerThefork') },
    { value: 'cover', label: t('providerCover') },
    { value: 'mesaya', label: t('providerMesaya') },
    { value: 'tablecheck', label: t('providerTablecheck') },
  ], [t]);
