    ...
    <>
      ...
      {onRemove && (
        <button
          ...
          className="-mr-2 inline-flex h-9 w-9 items-center justify-center rounded-full text-base leading-none text-current hover:bg-black/10 focus-visible:outline-none focus-visible:[box-shadow:var(--focus-ring)]"
        >
          ×
        </button>
      )}
